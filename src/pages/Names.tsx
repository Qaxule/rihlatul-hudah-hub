      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6 mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            The Most Beautiful Names. Tap on any name to learn more with Quran and Hadith references.
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {namesOfAllah.map((name, index) => (
            <Link to={`/names/${index + 1}`} key={index}>
              <Card className="shadow-soft hover:shadow-elevated transition-all group cursor-pointer h-full">
